            ...
            <div class="flex flex-col group">
                ...
                <div class="mb-6 text-center">
                    ...
                    <div class="flex flex-wrap justify-center gap-1.5 px-2">
                        @forelse($sizes as $size)
                            <button type="button"
                                    data-size-button
                                    onclick="setDashboardProductSize({{ $product->id }}, @js($size), this)"
                        ...
                        @empty
                            <button type="button"
                                    data-size-button
                                    onclick="setDashboardProductSize({{ $product->id }}, 'Standard', this)"
                ...
                @auth
                    <form action="{{ route('cart.store') }}" method="POST">
                        ...
                        <input type="hidden" id="dashboard-selected-size-{{ $product->id }}" name="size" value="{{ $defaultSize }}">
...
<button type="submit"
    ...
    <script>
        function setDashboardProductSize(productId, size, buttonEl) {
            const input = document.getElementById(`dashboard-selected-size-${productId}`);
