        ...
        <select name="quality" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="sizes" placeholder="40-45=2 or 42=1, 43=3"
                        class="w-full bg-[#111] border border-white/10 rounded-xl p-4 text-white focus:border-[#F53003]">
                    <p class="text-[9px] text-gray-600 mt-2 font-bold uppercase tracking-widest">Format: 40-45=2 or 42=1 (qty auto-limited to 1-6). Leave blank if not available.</p>
                </div>
            </div>
